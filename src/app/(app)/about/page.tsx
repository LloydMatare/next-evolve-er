...
export default function AboutPage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="bg-[#f3f3f3] border border-gray-200 rounded-sm p-8 md:p-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#170d43] mb-6">Event Synopsis</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4 text-base text-gray-600">
                <p className="flex items-start">
                  <span className="font-bold text-[#170d43] mr-2 min-w-[120px]">Theme:</span>
                  <span>Empowering Africa&apos;s Digital Leap</span>
                </p>
                <p className="flex items-start">
                  <span className="font-bold text-[#170d43] mr-2 min-w-[120px]">Dates:</span>
                  <span>11-12 June 2026</span>
                </p>
              </div>
              <div className="space-y-4 text-base text-gray-600">
                <p className="flex items-start">
                  <span className="font-bold text-[#170d43] mr-2 min-w-[120px]">Venue:</span>
                  <span>Harare International Conference Centre (HICC)</span>
                </p>
                <p className="flex items-start">
                  <span className="font-bold text-[#170d43] mr-2 min-w-[120px]">Organized by:</span>
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white border border-gray-200 rounded-sm p-8 card-hover">
              ...
              <h3 className="text-xl font-bold text-[#170d43] mb-4">Digital Hub</h3>
              <p className="text-gray-600 leading-relaxed">
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-[#f3f3f3] border border-gray-200 rounded-sm p-8">
              ...
              <h3 className="text-xl font-bold text-[#170d43] mb-4">Collaborative Platform</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-[#f3f3f3] border border-gray-200 rounded-sm p-8">
              ...
              <h3 className="text-xl font-bold text-[#170d43] mb-4">Innovation Showcase</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-[#f3f3f3] border border-gray-200 rounded-sm p-8">
              ...
              <h3 className="text-xl font-bold text-[#170d43] mb-4">Policy Catalyst</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      {/* CTA Section */}
      <section className="section-padding bg-[#170d43] text-white">
        <div className="container-custom max-w-4xl text-center">
          ...
          <Link href="/register">
            <Button
              size="lg"
              className="bg-[#ffcc00] hover:bg-[#ec7211] text-white font-semibold mt-4 md:mt-0 text-sm px-10 py-6 rounded-sm"
            >
              Register Now
            </Button>
          </Link>
